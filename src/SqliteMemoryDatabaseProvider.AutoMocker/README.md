...
This package provides overloads for `AutoMocker` and `DbContext` to aid with creating in-memory databases for unit tests. This package should only be used with projects using EntityFramework version 7.x.x.
